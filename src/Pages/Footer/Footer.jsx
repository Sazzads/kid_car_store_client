...
const Footer = () => {
    return (
        <footer>
            <div className="footer px-10 pt-10 pb-3 bg-neutral text-neutral-content">
                <div>
                    <img src={logo} className='h-10' alt="" />
                    <p><span className='text-xl'>Kid Car Store</span><br />since 1999 <br />Shop No:231, Block:B, Floor:4</p>
                </div>
                <div>
                    <p className='text-xl text-left'>Kid Car Store<br />Panthapath Dhaka,1200</p>
                </div>
                <div>
            ...
            <div className="bg-neutral text-neutral-content pb-5">
                <div className="text-center">
                    <p>Copyright © 2023 - All right reserved by Sazzad</p>
                </div>
            </div>
        </footer>
    );
